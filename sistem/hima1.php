        ...
        <!-- /. NAV SIDE  -->
          <div id="page-wrapper" >
            <div id="page-inner">
              <div class="row">
                <div class="col-lg-12">
                  <h2><i class="fa fa-user"> Data Pemilihan HIMA Manajemen</i></h2>
					...
					$data_dpt = mysqli_query($koneksi,"SELECT * FROM tbl_paslon WHERE jenis='3' LIMIT ".$limit_start.",".$limit);
				...
				?>
					...
					elseif ($_SESSION['jurusan'] == '4') { echo "Ekonomi Pembangunan"; }
								...
								<td><a class="btn btn-danger btn-circle" onclick="return confirm('Yakin RESET suara ini !!!')" href="reset_1.php?nim=<?php echo $d['nim']; ?>">Reset</a></td>
                            </tr>
                               <?php
