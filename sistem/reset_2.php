...
$pilih = mysqli_query($koneksi,"SELECT * FROM tbl_paslon WHERE nim='$nim' AND jenis='4'");
while($data = mysqli_fetch_array($pilih)){

$hapus = mysqli_query($koneksi,"DELETE FROM tbl_paslon WHERE nim='$nim' AND jenis='4'");
