          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h3 align="center"><b>Pemilihan KMPS Akuntansi</b></h3>
                  <form action="" method="post">
                    <?php
					$data_paslon = mysqli_query($koneksi,"SELECT * FROM data_paslon where jenis='4' order by no_urut ASC");
                    while($d = mysqli_fetch_array($data_paslon)){
                      ?>
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
                            <input type="hidden" name="jenis" class="form-control" value="4">
