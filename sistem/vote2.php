          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h3 align="center"><b>PEMILIHAN SENATOR</b></h3>
                  <form action="" method="post">
                    <?php
					$data_paslon = mysqli_query($koneksi,"SELECT * FROM data_paslon where jenis='2' order by no_urut ASC");
                      ...
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
							...
							<td style="background-color: #9c28b1; color: white; font-size: 30px; text-align: center;"><b><?php 
							    if ($d['no_urut'] == '1') { echo "SETUJU"; }
                        ...
                        <tr>
                          ...
                          <tr>
                            <td style="text-align:center; background-color:powderblue;"><h4><?php echo $d['nim']; ?></h4></td>
                          </tr>
                          <tr>
