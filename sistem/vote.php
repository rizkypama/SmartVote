          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h3 align="center"><b>PEMILIHAN PASANGAN CALON OSIS</b></h3>
                      ...
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
							...
							<td style="background-color: #214761; color: white; font-size: 30px; text-align: center;"><b><?php echo $d['no_urut']; ?></b>
                            </td>
                          </tr>
                          <tr>
                        ...
                        <!--<tr>
                            <td style="text-align:center;"><h4><?php echo $d['nim']; ?></h4></td>
                          </tr>-->
                          <tr>
