    ...
    <div class="adjust-nav">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">
          ...
          <h4 style="color: white;">KPRM FEB UWKS</h4>
        </a>
        ...
        <!-- /. NAV SIDE  -->
          <div id="page-wrapper" >
            <div id="page-inner">
              <div class="row">
                <div class="col-lg-12">
                  <h2><i class="fa fa-user"> Data Pemilihan HIMA Ekonomi Pembangunan</i></h2>
					...
					$data_dpt = mysqli_query($koneksi,"SELECT * FROM tbl_paslon WHERE jenis='4' LIMIT ".$limit_start.",".$limit);
				...
				?>
					...
					elseif ($_SESSION['jurusan'] == '4') { echo "Ekonomi Pembangunan"; }
								...
								<td><a class="btn btn-danger btn-circle" onclick="return confirm('Yakin RESET suara ini !!!')" href="reset_2.php?nim=<?php echo $d['nim']; ?>">Reset</a></td>
                            </tr>
                               <?php
  ...
  <div class="row">
    <div class="col-lg-12" >
      ...
      <a href="https://www.youtube.com/channel/UCOAdMyFuPTcmi1TExyynO6w" style="color:#fff;" target="_blank">
		KPRM FEB UWKS <?php echo date('Y') ?></a>
