  ...
  <div id="page-wrapper" >
    <div id="page-inner">
	    ...
	    <div id="mygraph2"></div>
         ...
         title: {
            text: 'HASIL SUARA <?php echo $gusmint['voting']; ?>'
         },
         xAxis: {
         ...
         yAxis: {
            ...
            [
        <?php
            $kandidat = mysqli_query($koneksi,"SELECT * FROM data_paslon where jenis='1'");
            while ($ambil = mysqli_fetch_array($kandidat)){
                $i = $ambil['no_urut'];
				$hasil = $ambil['nm_paslon'];
                $paslon = mysqli_query($koneksi,"select * from tbl_paslon where vote='$i' AND jenis='1'");
	    ...
	    <div id="mygraph11"></div>
			...
			data: [
				<?php 
                $suara1 = mysqli_query($koneksi,"select * from tbl_paslon where jenis='1'");
